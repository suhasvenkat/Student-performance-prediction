...
class Datatransformationconfig:
    preprocessor_ob_file_path=os.path.join('artifact','preprocesso.pkl')
...
class DataTransformation:
    ...
    def get_data_transfomer_object(self):
        '''
        This function is responsible for data transformation with respective to different data'''
        try:
            ...
            logging.info("numerocal columns scaling is completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(f"Applying preprocessing on object on train df and test df")
